...
<i class="fa fa-home" style="font-size:35px;color:white; position: absolute; top: 10px; left: 25px;" on:click={Homepage}></i>
<style>

.datagrid-container {
  width: 80%; /* Use 100% width to adapt to the parent container */
